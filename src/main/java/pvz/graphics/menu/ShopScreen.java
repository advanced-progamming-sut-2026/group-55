...
public class ShopScreen extends BaseScreen {
    ...
    private final Texture popupDimTexture;
    ...
    public void show() {
        super.show();
        appState.setCurrentMenu(MenuName.SHOP);
    }
    ...
    private Table createDimBackground() {
        ...
        TextureRegionDrawable dimDrawable =
                new TextureRegionDrawable(
                        new TextureRegion(popupDimTexture)
                );
